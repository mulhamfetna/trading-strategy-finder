...
export const useBacktestStore = defineStore('backtest', () => {
  ...
  async function _runSimple(settings: ReturnType<typeof useSettingsStore>) {
    ...
    const runPayload = {
      ...
      tp_soft_points:       settings.simpleParams.tp_soft_points,
      tp_hard_points:       settings.simpleParams.tp_hard_points,
      flip_entry_direction: settings.simpleParams.flip_entry_direction,
