...
| **WS-KALMAN** | Kalman / signal-fusion study (M0–M3) | `dev` (…→21d940a) | ✅ CLOSED 2026-07-02 — edge NOT confirmed | M0 ceiling 9× ($1.3M); M1 STOP (56.7%<57.5%); M2 +$41k single-split → +8% walk-forward (2/4); M3 DEAD (−12%). Payoff pinned 0.74 → breakeven 57.5% | closed; re-open only with longer OOS. Docs: `docs/RESEARCH_KALMAN_FUSION_STUDY.md` + `docs/KALMAN_FUSION_TRIALS_DEEPDIVE.md` |
