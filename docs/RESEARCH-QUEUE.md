...
| RQ-2 | **Retail short-side study** | N3 + WS-GRID | #142 | **CLOSED via FU-8 (#160, 2026-08-20)** — Retail loses BOTH WAYS (short −$37.15/ev CI<0; the anti-premium is chop, not drift); claim `FU8-RETAIL-SHORT-CLOSED` |
