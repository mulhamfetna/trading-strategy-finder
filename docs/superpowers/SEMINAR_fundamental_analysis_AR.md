...
# 🚨 تصحيح — 2026-07-13. اقرأ هذا أولاً.

**هذه الندوة تُعلّم نتيجةً سلبية بثقةٍ لم تستحقّها. أنا كتبتُها، وأنا من أخطأ في هذا القدر من اليقين.**

## الخطأ

الوثيقة كلها تُحاجج بأنّ الأخبار الاقتصادية الأمريكية المجدولة **«مُسعّرة سلفاً»** — وتفعل ذلك اعتماداً
على **52 إلى 103 حدثاً فقط**. و«موت» إشارة المفاجأة خارج العيّنة استند إلى **28 حدثاً**.

**ولم أطرح قطّ السؤال الأكثر بداهةً: هل كانت الدراسة كبيرة كفايةً لكشف أي شيء أصلاً؟**

**لم تكن كذلك.**

| حجم الأثر الحقيقي | **القوّة التي امتلكناها فعلاً (n=52)** | الأحداث اللازمة لقوّة 80% |
|---|---|---|
| r = 0.10 | **10%** | 783 |
| **r = 0.11 — الحجم الذي قِسناه فعلاً** | **12%** | **647** |
| r = 0.20 | 29% | 194 |

> **🍼 بلغة مبسّطة**
>
> **«القوّة الإحصائية» تعني: إن كان الأثر موجوداً حقاً، فما احتمال أن يرصده اختبارنا؟**
>
> **قوّتنا كانت 12%.** أي أنه **حتى لو كانت الأخبار تُحرّك السوق تماماً كما كنّا نأمل، لكان اختبارنا قد
> فوّتها 88 مرّة من كل 100.**
>
> تخيّل أنك تختبر إن كانت عملةٌ ما مغشوشة — **برميها أربع مرّات**. تحصل على صورتين وكتابتين فتُعلن: «العملة
> عادلة». **أنت لم تُثبت أنّ العملة عادلة. أثبتّ فقط أنك لم ترمِها بما يكفي.** وهذا بالضبط ما فعلته هذه
> الندوة.

**وثمّة تفصيلة تجعل الأمر أسوأ:** حين اختبرنا أخيراً ما إذا كانت المفاجأة تتنبّأ بـ**حجم** الحركة، جاء
الجواب **موجباً في المقاييس الأربعة المستقلّة كلّها** (+0.105, +0.121, +0.105, +0.107) — نفس الإشارة، في
كل مرّة — **وكلها أُبلغ عنها بأنها «غير ذات دلالة».**

**وعند قوّة 12%، فإنّ «غير ذات دلالة» لا تعني شيئاً تقريباً.**

## إذاً ما الحكم الأمين؟

> ### ليس: *«الأخبار المجدولة لا تنفع.»*
> ### بل: *«لا نستطيع أن نعرف بستّة عشر شهراً من بيانات الأسعار.»*

## عنق الزجاجة — وهو **ليس** ما ألقت عليه هذه الندوة اللوم

الوثيقة تلوم **السوق** (الكفاءة). **لكنّ القيد الحقيقي هو مجموعة بياناتنا نحن.**

**ليست الرزنامة** — ففي FRED عقودٌ من الإصدارات مجاناً. **بل بيانات أسعارنا:** 2025-01-01 → 2026-05-19.
**ستّة عشر شهراً ونصف.**

| تاريخ الأسعار | الإصدارات | القوّة |
|---|---|---|
| **ما امتلكناه** | **52** | **12%** ❌ |
| + 2024 (كامل، وموجود على القرص بلا استخدام) | ~100 | 19% |
| 5 سنوات | 188 | 32% |
| 10 سنوات | 376 | 57% |
| **العودة إلى ~2009** | **640** | **80%** ✅ |

**ولا نحتاج تاريخاً متّصلاً** — بل فقط نوافذ ±60 دقيقة حول كل إصدار. أي نحو **78,000 شمعة** لـ650 حدثاً.
**اقتناءٌ صغير ورخيص.**

## ما يبقى صحيحاً في هذه الندوة

**كل ما هو *قياس* يبقى صحيحاً. وكل ما هو *استنتاج* حول نفع الأخبار لا يبقى.**

| ✅ **ما زال صحيحاً** | ❌ **مسحوب** |
|---|---|
| الرزنامة متحقَّقة — ذروة 8.32× تهبط بالضبط على الإصدار | «إشارة المفاجأة ميّتة» |
| السوق **هادئ** قبل الإصدار (0.78× عند −2 دقيقة) | «الأخبار المجدولة مُسعّرة سلفاً» |
| **قاعة الحجر لا تُسرّب** (تحقّقنا 2026-07-13) | «لا تشترِ بيانات الإجماع» *(مُعلَّق)* |
| الفيتو بلا جدوى بنيوياً — نحن خارج السوق في **77%** من الإصدارات | |
| شمعات الأربع ساعات **لا تستطيع رؤية** إصدار 08:30 | |
| «ميزة الـ72 ألفاً» مجرّد ارتداد ناسداك — الرزنامات المزيّفة تُعيد إنتاجها | |

## 🎓 الدرس — وهو أهمّ درس في هذه الوثيقة كلّها

**كنتُ صارماً بشأن المقارنات المتعدّدة. وصارماً بشأن التحقّق خارج العيّنة. وبنيتُ آلة اختبار عدمي واستخدمتُها
لأمسك ثلاثة سرابات. ثم لم أسأل ولا مرّة واحدة ما إذا كانت العيّنة كبيرة كفايةً لرؤية أي شيء أصلاً.**

> **الاختبار العدمي يخبرك إن كان الأثر الذي *وجدتَه* حقيقياً.**
>
> **تحليل القوّة يخبرك إن كنتَ *تستطيع أن تجده* من الأساس.**
>
> **أجرينا الأول وتخطّينا الثاني. كلاهما إلزامي. ولا يُغني أحدهما عن الآخر.**

**اقرأ بقيّة هذه الندوة من أجل المنهج والأفخاخ والهندسة — كلها سليمة وتستحقّ التعلّم. لكن اقرأ *خلاصتها*
على أنها «غير مُثبتة»، لا على أنها «مُفنَّدة».**
