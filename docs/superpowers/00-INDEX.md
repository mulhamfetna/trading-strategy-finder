...
| **▸** | [**`DIST-00-WORKSTREAM-REPORT.md`**](DIST-00-WORKSTREAM-REPORT.md) | 🆕 **#7 COMPLETE** — fit-our-distribution, one report: trade P&L truncated, raw returns fat (α≈3), vol-scaled stop rejected → keep the fixed stop | 12 min | |
...
| **▸** | [**`DIST-02-D1-per-trade-pnl-is-truncated.md`**](DIST-02-D1-per-trade-pnl-is-truncated.md) | 🆕 **#7 · D1** — per-trade P&L is TRUNCATED (bounded, bimodal, light tails) — the stop caps the fat tail | 7 min | |
...
| **▸** | [**`SIZE-00-WORKSTREAM-REPORT.md`**](SIZE-00-WORKSTREAM-REPORT.md) | 🆕 **SIZING COMPLETE** — one report: full Kelly 2.5% but size ~quarter-half Kelly (0.6–1.2%), edge-champs only, hard cap; vol-target promising-pending-OOS | 12 min | |
...
| **▸** | [**`SIZE-04-Z3-vol-targeting.md`**](SIZE-04-Z3-vol-targeting.md) | 🆕 **Sizing · Z3** — vol-targeting contracts PROMISING (Sharpe 3.2→3.9, both halves) but in-sample → needs OOS, don't adopt | 6 min | |
| **▸** | [**`SIZE-05-Z4-pnldd-objective.md`**](SIZE-05-Z4-pnldd-objective.md) | 🆕 **Sizing · Z4** — PnL:DD ratio flat half→full Kelly, but absolute DD (30–62%) binds → ~half-Kelly. Fraction CLOSED | 6 min | |
