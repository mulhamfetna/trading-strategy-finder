...
| **FU-8** (#160) | **Retail short × state confirmation** (absorbs RQ-2) | The anti-premium is real on 7 instruments but its short side was never designed; a state filter could be what makes it tradeable at cost. Fresh-design requirement stands (its history is consumed). | Design AFTER FU-5/FU-6 teach us which state variables carry signal; pre-register geometry a priori; forward-era element required. | **✅ CLOSED (2026-08-20)**: FU-5/6 removed the state rationale; the frozen mirrored SHORT loses on ALL legs (pooled NQ+RTY −$37.15/ev, CI [−$71,−$3] SIGNIFICANTLY negative). ⭐ **Retail loses BOTH WAYS** — the anti-premium is CHOP not drift (long −$78 gross, short −$22 gross on NQ); avoid, never trade; RQ-2/#142 closes. Claim `FU8-RETAIL-SHORT-CLOSED`, 52/52; record F-14 |
